...
const ERROR_TYPES = {
  generic: {
    ...
    message: "Don't worry, even the best pups trip sometimes. Let's try that again!",
  },
  network: {
    icon: WifiOff,
    iconColor: '#FF9800',
    title: 'Lost connection',
    message: "Looks like we're having trouble reaching the internet. Check your connection and we'll be right back!",
  },
  server: {
    icon: ServerCrash,
    iconColor: '#EF5350',
    title: 'Taking a quick nap',
    message: "Our servers are catching their breath. Give us a moment and try again!",
  },
  validation: {
    icon: XCircle,
    iconColor: '#F4A261',
    title: "That doesn't look right",
    message: 'Double-check what you entered and give it another go!',
  },
  notFound: {
    icon: AlertCircle,
    iconColor: '#9E9E9E',
    title: "Can't find that",
    message: "We searched high and low but came up empty-pawed. Try a different path!",
  },
}
